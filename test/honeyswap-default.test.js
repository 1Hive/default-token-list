...
import gnosis from "../src/tokens/gnosis.json" assert { type: "json" };
import polygon from "../src/tokens/polygon.json" assert { type: "json" };
import zktestnet from "../src/tokens/zksynctestnet.json" assert { type: "json" };
...
describe("Gnosis Tests", () => {
  const defaultTokenList = buildList(gnosis);
...
describe("Polygon Tests", () => {
  const defaultTokenList = buildList(polygon);
...
describe("ZkSync Tests", () => {
  const defaultTokenList = buildList(zktestnet);
